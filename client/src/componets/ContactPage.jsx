...
const ContactPage = () => {
  ...
  function handleSubmit(e) {
    ...
    const url = `https://wa.me/8649851739?text=${encodeURIComponent(text)}`;
    ...
    <div className={contactPageStyles.pageContainer}>
      ...
      <div className={contactPageStyles.gridContainer}>
        ...
        <div className={contactPageStyles.infoContainer}>
          ...
          <iframe
            src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d14745.708902491256!2d86.9592853!3d22.4549909!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x3a1d7bcae512b101%3A0xd6cf20a23cf93fab!2sJhargram%2C%20West%20Bengal!5e0!3m2!1sen!2sin!4v1700000000000"
          ...
          <div className={contactPageStyles.hoursContainer}>
              <h4 className={contactPageStyles.hoursContainer}>Clinic Hours</h4>
