...
//function to get the time in 24hours
...
//to convert 12 hrs coming from 24hr time
...
export default function DashboardPage({ apiBase }) {
  ...
  //also check whether appt is cancel or completed then we connot change
