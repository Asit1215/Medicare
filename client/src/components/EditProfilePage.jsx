...
//helper functions similar to the dashboard to the dashboard page
...
//this functions will prevent from the duplicate slots
...
export default function EditProfilePage({ apiBase }) {
  ...
  const API_BASE = "https://medicare-server-mu64.onrender.com/api/doctors";
 ...
 //to change availability
  ...
  //to reset the profile back to initial side
