...
const DEFAULT_HOST = "https://medicare-server-mu64.onrender.com".replace(/\/$/, "");
...
export default function ServiceDetail() {
  ...
  function sortServiceDates(datesArr) {
    ...
    const future = parsed
      .filter((p) => dateVal(p.date) >= todayVal)
      .sort((a, b) => dateVal(a.date) - dateVal(b.date)); // accending order earliest future first (includes today)
