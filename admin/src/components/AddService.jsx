...
const AddService = ({ serviceId }) => {
  ...
  // Date and time controls for adding slots.
  const now = new Date();
  ...
  const ampm = ["AM", "PM"];
  // initial values as strings matching option
  ...
  //user can select previous year/month/date. from today
  useEffect(() => {
  ...
  //submit funtion for creation or update
