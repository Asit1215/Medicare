...
// HELPER FUNCTIONS
// this function will give output in minutes and accordidng to that it will manage am : pm
...
// this function will convert (YYYY-MM-DD) to date Date Month year
...
const AddPage = () => {
  ...
  //computes todays date in local timezone.
  ...
  //it will show a toast for 3 sec only
  useEffect(() => {
  ...
  //this funtion show the image preview
  ...
  // this function will remove the image priview
  ...
  async function handleAdd(e) {
    ...
    try {
      ...
      const API_BASE = window.location.hostname === "localhost" ? "http://localhost:4000/api" : "https://medicare-server-mu64.onrender.com/api";
