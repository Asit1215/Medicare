...
//to prevent privious date comes first that is upcomming date comes first
...
const ServiceAppointmentsPage = () => {
  ...
  //to reschedule the appointment for later but not on previous day
            ...
            <label className={serviceAppointmentsStyles.searchLabel}>
              ...
              <div className=" flex items-center gap-2 relative w-full">
                ...
                <input
                  ...
                  placeholder="Search b patient or service..."
