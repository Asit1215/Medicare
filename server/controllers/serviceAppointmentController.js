...
//This function will create the fronted url
...
//this funtion will get the user form clerk and return the user details
...
export const getServiceAppointmentStats = async (req, res) => {
  try {
    const services = await Service.aggregate([
      ...
      { $sort: { createdAt: -1 } },
    ]); // it willl give you total appointment, complete appt
