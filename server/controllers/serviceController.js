...
// Helpers Function
// so this functin converts array like input into a Clean array
...
// So this function takes date-time strings and group them into a YYYY-MM-DD with the time
...
export async function updateService(req, res) {
  try {
    ...
    const b = req.body || {};
    const updateData = {};
    // to update each field if already then update them 
      ...
      try {
        ...
        if (up?.secure_url) {
          ...
          if (existing.imagePublicId) {
            // it will remove the old image and replace it new
            try {
